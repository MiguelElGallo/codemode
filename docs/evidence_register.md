...
| azure-openai-client-snippet-2026-05-07 | Azure OpenAI deployment uses the OpenAI SDK Azure client with endpoint `https://foundry-argus.cognitiveservices.azure.com/` and API version `2024-12-01-preview`. | User-provided deployment snippet | 2026-05-07 | Deployment snippet received 2026-05-07 | Azure OpenAI live smoke | Deployment name still comes from `--provider-model`; do not record API keys. |
