...
| --- | --- | --- | --- | --- | --- | --- |
| pydantic-code-mode-docs-2026-05-06 | Pydantic Code Mode supports code-driven tool orchestration through one `run_code` tool and has documented runtime constraints. | https://pydantic.dev/docs/ai/harness/code-mode/ | 2026-05-07 | Installed package README and public docs checked 2026-05-07 | Benchmark introduction, real Code Mode arm docs | Use before making Code Mode orchestration claims; still pair with actual harness implementation evidence. |
...
| azure-openai-client-snippet-2026-05-07 | Azure OpenAI deployment uses the OpenAI SDK Azure client with endpoint `https://foundry-argus.cognitiveservices.azure.com/` and API version `2024-12-01-preview`; Azure AI Foundry can also provide a deployment chat-completions URL with `api-version=2025-01-01-preview`. | User-provided deployment snippets | 2026-05-07 | Deployment snippets received 2026-05-07 | Azure OpenAI live smoke | Deployment name still comes from `--provider-model`; do not record API keys. |
